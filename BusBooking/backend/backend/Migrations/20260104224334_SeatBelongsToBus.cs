...
{
    /// <inheritdoc />
    public partial class SeatBelongsToBus : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusCompanies_Users_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Promotions_BusCompanies_BusCompanyId",
                        column: x => x.BusCompanyId,
                        principalTable: "BusCompanies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: true),
                    PassengerProfileId = table.Column<int>(type: "int", nullable: true),
                    ...
                    CancellationProcessedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_PassengerProfiles_PassengerProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Promotions_BusCompanyId",
                table: "Promotions",
                column: "BusCompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_PassengerProfileId",
                table: "Tickets",
